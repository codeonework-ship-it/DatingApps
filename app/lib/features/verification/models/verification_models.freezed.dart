...
// pending, under_review, resolved
  ...
  @override
  String toString() {
    return 'Report(id: $id, reporterId: $reporterId, reportedUserId: $reportedUserId, reason: $reason, createdAt: $createdAt, messageId: $messageId, description: $description, status: $status, reviewedAt: $reviewedAt, reviewedBy: $reviewedBy, action: $action)';
  }
...
// low, medium, high
  ...
  @override
  String toString() {
    return 'SafetyFlag(id: $id, userId: $userId, createdAt: $createdAt, flagType: $flagType, severity: $severity, description: $description, isResolved: $isResolved, action: $action, actionedAt: $actionedAt)';
  }
